...
def main():
    ...
    subtitle = "<div style='text-align: center; color: black; padding: 10px; background-color: lightgrey; font-weight: bold;'>A companion to help solve the New York Times 'Spelling Bee' puzzle.</div>"
